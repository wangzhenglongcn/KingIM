...
public class GroupUserController {
    ...
    public @ResponseBody String getMemberByGroupId(int groupId){
    ...
    public @ResponseBody String getNewMemberByGroupId(int groupId,int userId){
    ...
    public @ResponseBody Integer batchAdd(String userIds,int groupId) {
