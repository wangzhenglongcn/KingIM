...
<link rel="stylesheet" href="http://114.251.65.250:2084/layim/css/layui.css">
<style>
...
<script src="http://114.251.65.250:2084/layim/layui.js"></script>
<script>
layui.use(['layim', 'flow'], function(){
  ...
  flow.load({
	    ...
	    ,done: function(page, next){ //到达临界点（默认滚动触发），触发下一页
	      ...
	      //申请添加你为好友
	        $.ajax({
	      		url:"http://114.251.65.250:2084/friendApplyController/getByToUserId",
	      		type: "POST",
	      		async : true,
    ...
    agree: function(othis){
      ...
      parent.layui.layim.setFriendGroup({
        ...
        ,submit: function(group, index){
    	   $.ajax({
    			url:"http://114.251.65.250:2084/friendApplyController/updateStatus",
    			type: "POST",
    			async : true,
